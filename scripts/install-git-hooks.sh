...
echo "pre-push:    optional coverage gate (off by default)"
echo "             enable:  git config macverbs.coveragePush true"
echo "             disable: git config --unset macverbs.coveragePush"
